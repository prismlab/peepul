...
val merge : ltr:ae op
          ...
          -> Pure s (requires (forall e. mem e ltr.l ==> not (member (get_id e) atr.l)) /\
                    ...
                    (ensures (fun res -> ((get_id_s a >= get_id_s b) ==> res = a) /\
                                      ...
                                      (get_id_s res >= get_id_s a /\ get_id_s res >= get_id_s b /\ get_id_s res >= get_id_s l) /\
                                      (res = a \/ res = b)))
#set-options "--z3rlimit 10000"
...
val lemma : l:list (nat * op)
          -> Lemma (requires unique l)
                  (ensures (forall ele. member (get_id ele) l /\ (get_id ele > 0) ==> 
