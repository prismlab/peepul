...
val project1 : i:nat
             ...
             -> Pure (list (nat * C.op))
                    ...
                    (ensures (fun r -> (forall id. member id r <==> member id l.l /\ 
                                  ...
                                  (forall id. member id r <==> (member id l.l /\ get_key (get_eve id l.l) = i)) /\ unique r /\
...
val project : i:nat
            ...
            -> Pure (ae C.op)
                   ...
                   (ensures (fun r -> (forall id. member id r.l <==> member id l.l /\ 
                                   get_op (get_eve id l.l) = (i, (C.Add (get_val (get_eve id l.l))))) /\
              (forall id. member id r.l <==> (member id l.l /\ get_key (get_eve id l.l) = i)) /\ unique r.l /\
...
let merge ltr l atr a btr b =
  assert (forall i. mem_key_s i l ==> mem_key_s i a /\ mem_key_s i b);
  let keys = get_key_lst l a b in
  assert (forall i. mem i keys <==> mem_key_s i a \/ mem_key_s i b);
...
val prop_merge21 : ltr:ae op
               ...
               -> Lemma (requires (forall e. mem e ltr.l ==> not (member (get_id e) atr.l)) /\
                                 ...
                                 (forall e. mem e ltr.l ==> not (member (get_id e) btr.l)) /\
                                 (sim ltr l /\ sim (union ltr atr) a /\ sim (union ltr btr) b))
             (ensures (forall e. mem e (merge ltr l atr a btr b) ==> mem_key (get_key_s e) (absmerge ltr atr btr).l))
...
val prop_merge22 : ltr:ae op
               ...
               -> Lemma (requires (forall e. mem e ltr.l ==> not (member (get_id e) atr.l)) /\
                                 ...
                                 (forall e. mem e ltr.l ==> not (member (get_id e) btr.l)) /\
                                 (sim ltr l /\ sim (union ltr atr) a /\ sim (union ltr btr) b))
           (ensures (forall e. mem e (absmerge ltr atr btr).l ==> mem_key_s (get_key e) (merge ltr l atr a btr b)))
...
val prop_merge2 : ltr:ae op
               ...
               -> Lemma (requires (forall e. mem e ltr.l ==> not (member (get_id e) atr.l)) /\
                                 ...
                                 (forall e. mem e ltr.l ==> not (member (get_id e) btr.l)) /\
                                 (sim ltr l /\ sim (union ltr atr) a /\ sim (union ltr btr) b))
               (ensures (forall ch. mem_key_s ch (merge ltr l atr a btr b) <==> mem_key ch (absmerge ltr atr btr).l))
