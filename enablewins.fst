...
let merge a b l = 
  History.lemma1 l; 
  let (ac, af) = get_state a in
  let (bc, bf) = get_state b in
  let (lc, lf) = get_state l in
...
let associativity h a b c lab lbc lac mab mbc m1 m2 mabc1 mabc2 = 
  ...
  I.lemma2 (fst (get_state l1)) (fst (get_state l2)) (fst (get_state lab)) (fst (get_state lbc)) (fst (get_state lac)) (fst (get_state a)) (fst (get_state b)) (fst (get_state c));
  admit()
