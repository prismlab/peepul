...
val rem1 : l:ae 
         ...
         -> Pure (list o)
           (requires true)
           (ensures (fun r -> (forall n. ((snd op = (Inc n) /\ mem op l.l /\ l.l <> []) ==> (sum r = sum l.l - n))) /\ 
                           (forall ele. mem ele r ==> mem ele l.l) /\ (unique r))) (decreases %[l.l])
let rec rem1 l op =
    match l with 
    |(A _ []) -> []
...
val rem : l:ae 
        ...
        -> Pure ae
          (requires true)
          (ensures (fun r -> (forall n. ((snd op = (Inc n) /\ mem op l.l /\ l.l <> []) ==> (sum r.l = sum l.l - n))) /\ 
...
val diff : a:ae
         ...
         -> Pure ae
          ...
          (ensures (fun d -> (forall e. mem e d.l <==> mem e a.l /\ not(mem e l.l)) /\
                          ...
                          (forall e e1. mem e d.l /\ mem e1 d.l /\ d.vis e e1 ==> mem e a.l /\ mem e1 a.l /\ a.vis e e1))) (decreases l)
let diff a l =
