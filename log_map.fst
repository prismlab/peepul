...
val pre_cond_merge1_a1 : l:A.s G.s -> a:A.s G.s -> b:A.s G.s 
                      -> Pure bool
                        ...
                        (forall e. mem e (A.get_val_s #G.s #G.op #G.rval ch l) ==> mem e (A.get_val_s #G.s #G.op #G.rval ch a) /\ mem e (A.get_val_s #G.s #G.op #G.rval ch b)) /\
                        (forall e e1. mem e (A.get_val_s #G.s #G.op #G.rval ch l) /\ mem e1 (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch l)) ==> G.fst e1 > G.fst e) /\
                        (forall e e1. mem e (A.get_val_s #G.s #G.op #G.rval ch l) /\ mem e1 (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)) ==> G.fst e1 > G.fst e)))))

#set-options "--z3rlimit 10000000"
let pre_cond_merge1_a1 l a b = 
  forallb (fun e -> A.mem_key_s (A.get_key_s #G.s e) a && A.mem_key_s (A.get_key_s #G.s e) b) l &&
  forallb (fun ch -> (forallb (fun e -> mem e (A.get_val_s #G.s #G.op #G.rval ch a) && mem e (A.get_val_s #G.s #G.op #G.rval ch b)) (A.get_val_s #G.s #G.op #G.rval ch l)) &&
  (forallb (fun e -> (forallb (fun e1 -> G.fst e1 > G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch l)))) (A.get_val_s #G.s #G.op #G.rval ch l)) &&
  (forallb (fun e -> (forallb (fun e1 -> G.fst e1 > G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)))) (A.get_val_s #G.s #G.op #G.rval ch l))) (A.get_key_lst l a b)

val pre_cond_merge1_a2 : l:A.s G.s -> a:A.s G.s -> b:A.s G.s 
                      -> Pure bool
                        (requires true)
                        (ensures (fun b1 -> (b1 = true <==> (forall ch. A.mem_key_s ch a \/ A.mem_key_s ch b ==> 
                          (G.pre_cond_merge1 (A.get_val_s #G.s #G.op #G.rval ch l) 
                          (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b)) /\
                          (forall e. mem e (A.get_val_s #G.s #G.op #G.rval ch l) ==> mem e (A.get_val_s #G.s #G.op #G.rval ch a) /\ mem e (A.get_val_s #G.s #G.op #G.rval ch b)) /\
            (forall e. mem e (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch l)) ==>
                           not (G.mem_id_s (G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)))) /\
            (forall e. mem e (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)) ==>
                           not (G.mem_id_s (G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s#G.s #G.op #G.rval ch l))))))))

#set-options "--z3rlimit 10000000"
let pre_cond_merge1_a2 l a b =
  forallb (fun ch -> G.pre_cond_merge1 (A.get_val_s #G.s #G.op #G.rval ch l) (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b) &&
  (forallb (fun e -> mem e (A.get_val_s #G.s #G.op #G.rval ch a) && mem e (A.get_val_s #G.s #G.op #G.rval ch b)) (A.get_val_s #G.s #G.op #G.rval ch l)) &&
  (forallb (fun e -> not (G.mem_id_s (G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)))) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch l))) &&
  (forallb (fun e -> not (G.mem_id_s (G.fst e) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s#G.s #G.op #G.rval ch l)))) (G.diff_s (A.get_val_s #G.s #G.op #G.rval ch b) (A.get_val_s #G.s #G.op #G.rval ch l)))) (A.get_key_lst l a b)
...
val merge2 : l:A.s G.s -> a:A.s G.s -> b:A.s G.s 
           ...
           -> Pure (A.s G.s)
             ...
             (ensures (fun r -> (forall ch. A.mem_key_s ch r <==> mem ch lst) /\ A.unique_key r /\
                             (forall ch. mem ch lst ==> (A.get_val_s #G.s #G.op #G.rval ch r) =
                               (G.merge1 (A.get_val_s #G.s #G.op #G.rval ch l) (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b)))))
                (decreases lst)

#set-options "--z3rlimit 10000000"
let rec merge2 l a b lst = A.merge2 #G.s #G.op #G.rval l a b lst
  (*)match lst with
  |[] -> []
...
let merge1_a l a b = A.merge1_a #G.s #G.op #G.rval l a b
...
val lemma1 : tr:ae (A.op G.op)
         ...
         -> Lemma (requires (A.sim_a #G.s #G.op #G.rval tr st) /\ (not (mem_id (get_id op1) tr.l)) /\
                          ...
                          G.pre_cond_op (A.get_val_s #G.s #G.op #G.rval (A.get_key op1) st) (A.project_op op1))
...
instance _ : A.alpha_map (G.s) (G.op) (G.rval) G.log = {
  A.lemma1 = lemma1;
  A.lemma4 = lemma4;
  A.lemma2 = lemma2;
  A.lemma7 = lemma7
...
val pre_cond_merge_a : ltr:ae (A.op G.op) 
                     ...
                     -> Tot (b1:bool {b1=true <==> (forall ch. A.mem_key_s ch a \/ A.mem_key_s ch b ==>
                          (G.pre_cond_merge (A.project ch ltr) (A.get_val_s #G.s #G.op #G.rval ch l)
...
let pre_cond_merge_a ltr l atr a btr b =
  forallb (fun ch -> (G.pre_cond_merge (A.project ch ltr) (A.get_val_s #G.s #G.op #G.rval ch l)
                                    (A.project ch atr) (A.get_val_s #G.s #G.op #G.rval ch a)
                                    (A.project ch btr) (A.get_val_s #G.s #G.op #G.rval ch b)) &&
...
val merge_a : ltr:ae (A.op G.op)
          ...
          -> Pure (A.s G.s) (requires (forall e. mem e ltr.l ==> not (mem_id (get_id e) atr.l)) /\
                 ...
                 (ensures (fun r -> (forall i. A.mem_key_s i l ==> A.mem_key_s i a /\ A.mem_key_s i b) /\
                                 ...
                                 (forall ch. A.mem_key_s ch r ==> (A.get_val_s #G.s #G.op #G.rval ch r) =
                 (G.merge1 (A.get_val_s #G.s #G.op #G.rval ch l) (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b))) /\
                  (forall ch. A.mem_key_s ch r ==> (A.get_val_s #G.s #G.op #G.rval ch r) =
                  (G.merge (A.project ch ltr) (A.get_val_s #G.s #G.op #G.rval ch l) (A.project ch atr) (A.get_val_s #G.s #G.op #G.rval ch a) (A.project ch btr) (A.get_val_s #G.s #G.op #G.rval ch b))) /\
                        (r = merge1_a l a b)))

#set-options "--z3rlimit 10000000"
let merge_a ltr l atr a btr b = A.merge_a #G.s #G.op #G.rval ltr l atr a btr b
...
val convergence2 : tr:ae (A.op G.op)
         ...
         (forall e e1. mem e (A.get_val_s #G.s #G.op #G.rval ch a) /\ mem e1 (A.get_val_s #G.s #G.op #G.rval ch a) /\ 
                    G.fst e <> G.fst e1 /\ G.fst e > G.fst e1 /\ G.ord e e1 (A.get_val_s #G.s #G.op #G.rval ch a)  <==> 
    mem e (A.get_val_s #G.s #G.op #G.rval ch b) /\ mem e1 (A.get_val_s #G.s #G.op #G.rval ch b) /\ G.fst e <> G.fst e1 /\
                    G.fst e > G.fst e1 /\ G.ord e e1 (A.get_val_s #G.s #G.op #G.rval ch b))) /\
          (forall ch. A.mem_key_s ch a /\ A.mem_key_s ch b ==>
    (forall e. G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch a) <==> G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch b))))
...
val lem_length : a:(A.s G.s)
               ...
               -> Lemma (requires (forall ch. mem ch lst ==> A.mem_key_s ch a /\ A.mem_key_s ch b) /\
                 ...
                 (forall e. G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch a) <==> G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch b))))
                 (ensures (forall ch. mem ch lst ==> (List.Tot.length (A.get_val_s #G.s #G.op #G.rval ch a) = List.Tot.length (A.get_val_s #G.s #G.op #G.rval ch b))))
                          (decreases lst)

let rec lem_length a b lst =
  match lst with
  |[] -> ()
  |ch::chs -> G.lem_length (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b); 
            lem_length a b chs
...
val convergence3 : a:(A.s G.s)
                 ...
                 -> Lemma (requires (forall ch. mem ch lst ==> A.mem_key_s ch a /\ A.mem_key_s ch b) /\
                                   (forall e. A.mem_key_s e a <==> A.mem_key_s e b) /\
                                    A.unique_keys lst /\ (forall ch. mem ch lst ==> 
    (forall e. G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch a) <==> G.mem_id_s e (A.get_val_s #G.s #G.op #G.rval ch b))) /\
    (forall ch. mem ch lst ==> (forall e. mem e (A.get_val_s #G.s #G.op #G.rval ch a) <==> mem e (A.get_val_s #G.s #G.op #G.rval ch b))) /\
                   (forall ch. mem ch lst ==> (List.Tot.length (A.get_val_s #G.s #G.op #G.rval ch a) = List.Tot.length (A.get_val_s #G.s #G.op #G.rval ch b))) /\
                    (forall ch. mem ch lst ==> 
           (forall e e1. mem e (A.get_val_s #G.s #G.op #G.rval ch a) /\ mem e1 (A.get_val_s #G.s #G.op #G.rval ch a) /\ 
                   G.fst e <> G.fst e1 /\ G.fst e > G.fst e1 /\ G.ord e e1 (A.get_val_s #G.s #G.op #G.rval ch a)  <==> 
                   mem e (A.get_val_s #G.s #G.op #G.rval ch b) /\ mem e1 (A.get_val_s #G.s #G.op #G.rval ch b) /\ 
                   G.fst e <> G.fst e1 /\ G.fst e > G.fst e1 /\ G.ord e e1 (A.get_val_s #G.s #G.op #G.rval ch b))))
                          (ensures (forall ch. mem ch lst ==> (A.get_val_s #G.s #G.op #G.rval ch a = 
                                                         A.get_val_s #G.s #G.op #G.rval ch b)))
                         (decreases lst)
#set-options "--z3rlimit 10000000"
let rec convergence3 a b lst =
  match lst with
  |[] -> ()
  |ch::chs -> G.lem_same (A.get_val_s #G.s #G.op #G.rval ch a) (A.get_val_s #G.s #G.op #G.rval ch b);
...
val prop_merge_a : ltr:ae (A.op G.op)
            ...
            -> Lemma (requires (forall e. mem e ltr.l ==> not (mem_id (get_id e) atr.l)) /\
                            ...
                            (A.sim_a #G.s #G.op #G.rval ltr l /\ A.sim_a #G.s #G.op #G.rval (union ltr atr) a /\ A.sim_a #G.s #G.op #G.rval (union ltr btr) b) /\
                             ...
                             (forall ch. A.mem_key_s ch a \/ A.mem_key_s ch b ==> 
                         (pre_cond_merge #G.s #G.op #G.rval (A.project ch ltr) (A.get_val_s #G.s #G.op #G.rval ch l)
                                             (A.project ch atr) (A.get_val_s #G.s #G.op #G.rval ch a)
                                             (A.project ch btr) (A.get_val_s #G.s #G.op #G.rval ch b)) /\
                            (forall e. mem e (A.project ch ltr).l ==> not (mem_id (get_id e) (A.project ch atr).l)) /\
                            (forall e. mem e (A.project ch atr).l ==> not (mem_id (get_id e) (A.project ch btr).l)) /\
                ...
                (ensures (A.sim_a #G.s #G.op #G.rval (absmerge ltr atr btr) (merge_a ltr l atr a btr b)))

#set-options "--z3rlimit 10000000"
let prop_merge_a ltr l atr a btr b = 
  A.prop_merge_a #G.s #G.op #G.rval #G.log ltr l atr a btr b
...
val prop_spec_a : tr:ae (A.op G.op)
                  ...
                  -> Lemma (requires (A.sim_a #G.s #G.op #G.rval tr st1) /\ (not (mem_id (get_id op) tr.l)) /\
                                    ...
                                    pre_cond_op_a st1 op)
                    (ensures A.opget op ==> (get_rval (A.app_op_a #G.s #G.op #G.rval st1 op)) =
                                                  ((A.spec_a #G.s #G.op #G.rval) op tr))

#set-options "--z3rlimit 1000000"
let prop_spec_a tr st op =
  G.prop_spec (A.project (A.get_key op) tr) (A.get_val_s #G.s #G.op #G.rval (A.get_key op) st) (A.project_op op)

val sim_a : tr:ae (A.op G.op)
          -> s1:(A.s G.s)
          -> Tot (b:bool {(b = true) <==> (forall k. A.mem_key_s k s1 ==> (exists e. mem e tr.l /\ get_id e = k /\ A.opset e)) /\
...
let sim_a tr s1 = A.sim_a #G.s #G.op #G.rval tr s1

#set-options "--z3rlimit 10000000" 
instance log_map : mrdt (A.s G.s) (A.op G.op) (G.rval) = {
  Library.init = A.init_a;
  Library.spec = spec_a;
  Library.sim = sim_a;
  Library.pre_cond_op = pre_cond_op_a;
